    ...
    return (
      <div className="bg-white black font-family-base relative pb4 bg-white black" style={{zIndex: 100}}>
        <header className="mx-auto md-max-width-4 lg-max-width-5 mb4 px1 md-px2 lg-px3 pt2 md-pt3 font-weight-500">
          <div className="h4 md-h3 red-small mb1 md-pl1" lang="en">Google Fonts + Japanese</div>
          ...
          <div className="sm-flex sm-mxn1 md-mxn2 line-height-4 font-weight-400">
            <HeaderColumn>
              <!-- TODO fix ja text, probably refers to early access -->
              <p><a href="https://fonts.google.com">Google Fonts</a> は、デザイナー ウェブフォントを直感的にご利用いただける、安定したオープンソース ディレクトリです。<a href="https://fonts.google.com/?subset=japanese" title="Google Fonts Japanese">Google Fonts 早期アクセス</a>では、現時点で完全にはサポートしていないフォントを試験的に提供しています。</p>
            ...
            <HeaderColumn lang="en">
              <p><a href="https://fonts.google.com">Google Fonts</a> provides an intuitive and robust directory of open source designer web fonts. <a href="https://fonts.google.com/?subset=japanese" title="Google Fonts Japanese">Google Fonts Japanese</a> shows our current set of Japanese typefaces.</p>
              <p>Japanese typeface design and font development presents many interesting challenges, from the time it takes to design thousands and thousands of available characters, to the technical infrastructure required to serve large font files as web fonts. We invite designers and developers to experiment with the Japanese web fonts now available on Google Fonts.</p>
            </HeaderColumn>
          </div>
        </header>
